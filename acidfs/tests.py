...
class FunctionalTests(unittest.TestCase):
    ...
    def test_read_write_file(self):
        fs = self.make_one()
        self.assertEqual(fs.hash(), "4b825dc642cb6eb9a060e54bf8d69288fbee4904")
        ...
        self.assertEqual(fs.hash("foo"), "e965047ad7c57865823c7d992b1d046ea66edf78")
    ...
    def test_read_write_file_in_subfolder(self):
        ...
        self.assertEqual(fs.hash("foo"), "4b825dc642cb6eb9a060e54bf8d69288fbee4904")
        with fs.open("foo/bar", "wb") as f:
            fprint(f, b"Hello")
        with fs.open("foo/bar", "rb") as f:
            self.assertEqual(f.read(), b"Hello\n")
        self.assertEqual(fs.hash("foo"), "c57c02051dae8e2e4803530c217ac38121f393d3")
    ...
    def test_modify_file(self):
        ...
        with fs.open("foo", "wb") as f:
            ...
            self.assertEqual(fs.hash("foo"), "c564dac563c1974addaa0ac0ae028fc92b2370f1")
        self.assertEqual(fs.open("foo", "rb").read(), b"Hello!\n")
        self.assertEqual(fs.hash("foo"), "10ddd6d257e01349d514541981aeecea6b2e741d")
